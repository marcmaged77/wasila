...
class Concept extends StatefulWidget {
  ...
  const Concept({ Key key, this.name , this.coverr, this.cover, this.id}): super(key: key);
...
class _MotionCourseState extends State<Concept> {
  Dio dio = new Dio();
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                              ...
                              image: DecorationImage(
                                  image: AssetImage('images/course-design.jpg'),
                                  fit: BoxFit.cover)),
                        ),
                      ),
                    ),
