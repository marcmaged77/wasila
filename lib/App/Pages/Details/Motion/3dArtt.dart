...
class Art3Course extends StatefulWidget {
  ...
  const Art3Course({ Key key, this.name , this.coverr, this.cover, this.id}): super(key: key);
...
class _MotionCourseState extends State<Art3Course> {
     Dio dio = new Dio();
