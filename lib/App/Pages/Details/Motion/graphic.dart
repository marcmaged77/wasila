...
class Graphic extends StatefulWidget {
  ...
  const Graphic({ Key key, this.name , this.coverr, this.cover, this.id}): super(key: key);
...
class _MotionCourseState extends State<Graphic> {
  Dio dio = new Dio();
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                              ...
                              image: DecorationImage(
                                  image: AssetImage('images/course-motion.jpg'),
                                  fit: BoxFit.cover)),
                        ),
                      ),
                    ),
